...
user_loc varchar(25),
user_subscription char(12) not null,
...
select song_name from songs inner join albums on songs.album_id=albums.album_id and 
 albums.album_id in (
select album_id from albums group by album_id having  max(no_of_songs)=15) 
;
